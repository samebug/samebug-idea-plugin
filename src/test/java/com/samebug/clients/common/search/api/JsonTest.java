...
import com.samebug.clients.common.search.api.json.Json;
...
//     jq . > src/test/resources/com/samebug/clients/common/search/api/jsontest/search-1.json
    ...
    InputStreamReader stream(final String fn) {
        return new InputStreamReader(getClass().getResourceAsStream("/com/samebug/clients/common/search/api/jsontest/" + fn + ".json"));
    }
