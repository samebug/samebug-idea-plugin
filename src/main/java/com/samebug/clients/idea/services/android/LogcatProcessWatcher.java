...
public class LogcatProcessWatcher implements AndroidDebugBridge.IDeviceChangeListener {
    ...
    private void createListener(@NotNull final IDevice device, Integer deviceHashCode) {
        ...
        final AndroidLogcatService.LogcatListener receiver = new LogcatWriter(logcatPreferences, scannerFactory.createScanner());
    ...
    private void removeReceiver(Integer deviceHashCode) {
        AndroidLogcatService.LogcatListener receiver = listeners.get(deviceHashCode);
        if (receiver != null) {
    ...
    private final Map<Integer, AndroidLogcatService.LogcatListener> listeners = new HashMap<Integer, AndroidLogcatService.LogcatListener>();
