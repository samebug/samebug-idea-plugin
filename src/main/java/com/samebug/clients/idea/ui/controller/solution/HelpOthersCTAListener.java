...
final class HelpOthersCTAListener implements IHelpOthersCTA.Listener {
    ...
    public void postTip(@NotNull final IHelpOthersCTA source, @NotNull final String tipBody, @Nullable final String sourceUrl) {
        ...
        TrackingService.trace(SwingRawEvent.writeTipSubmit(sourceComponent, transactionId, null));
        new CreateTipFormHandler(formData, controller.searchId) {
            ...
            protected void afterPostForm(@NotNull SearchHit<SamebugTip> response) {
                ...
                TrackingService.trace(SwingRawEvent.writeTipCreate(sourceComponent, transactionId, null, response));
            }
