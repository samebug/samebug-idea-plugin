...
public final class HelpRequestListFrameListener extends BaseFrameListener implements IHelpRequestListFrame.Listener {
    final HelpRequestListController controller;

    public HelpRequestListFrameListener(final HelpRequestListController controller) {
