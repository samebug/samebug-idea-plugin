...
public interface IHelpRequestTab {
    final class Model {
        public final IHelpRequest.Model helpRequest;
        public final List<ITipHit.Model> tipHits;

        public Model(Model rhs) {
            this(rhs.tipHits, rhs.helpRequest);
        }

        public Model(List<ITipHit.Model> tipHits, IHelpRequest.Model helpRequest) {
